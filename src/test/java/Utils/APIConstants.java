...
public class APIConstants{
    ...
    public static final String GET_EMPLOYEE_STATUS_URI =
            BaseURI+"/employeementStatus.php";
    public static final String DELETE_EMPLOYEE_URI =
            BaseURI+"/deleteEmployee.php";
    public static final String JOB_TITLE_EMPLOYEE_URI =
